...
{
    public static (List<Auteur> auteurs, List<Livre>) InitialiserDatas()
    {   
        ...
        {
            new Livre(1, "C# 4", "Les fondamentaux du langage", listeAuteurs.ElementAt(0), 533),
            new Livre(2, "VB.NET", "Les fondamentaux du langage", listeAuteurs.ElementAt(0), 539),
            new Livre(3, "SQL Server 2008", "SQL, Transact SQL", listeAuteurs.ElementAt(1), 311),
            new Livre(4, "ASP.NET 4.0 et C#", "Sous visual studio 2010", listeAuteurs.ElementAt(3), 544),
            new Livre(5, "C# 4", "Développez des applications windows avec visual studio 2010", listeAuteurs.ElementAt(2), 452),
            new Livre(6, "Java 7", "les fondamentaux du langage", listeAuteurs.ElementAt(0), 416),
            new Livre(7, "SQL et Algèbre relationnelle", "Notions de base", listeAuteurs.ElementAt(1), 216)
        };
    ...
    public static void Afficher<T>(this IEnumerable<T> source, string title)
    {
        ...
        source.Select(e => e?.ToString()).ToList().ForEach(e =>
        {
            Console.Write("\t- ");
            Console.WriteLine(e);
        });
